...
layout: default
title: "Bod Pod"
description: "Air-displacement plethysmography (Bod Pod) for body composition, body volume, RMR, and total energy expenditure at the Body Composition Lab."
---
...
<a href="{{ site.baseurl }}/pricing/#bodpod" style="padding: 0.35rem 0.8rem; border: 1px solid var(--gray-300); border-radius: 100px; font-size: 0.85rem; text-decoration: none; color: var(--gray-700); font-weight: 600;">Pricing →</a>
...
![Bod Pod]({{ site.baseurl }}/wp-content/uploads/2020/01/bodpod_1920x900-1024x480.png)
...
<img src="{{ site.baseurl }}/wp-content/uploads/2026/04/infant-in-todpod.png" alt="A toddler wearing a swim cap, seated in the Tod Pod chair insert with a tray across the lap" style="width: 100%; height: auto; border-radius: var(--radius);">
<img src="{{ site.baseurl }}/wp-content/uploads/2026/04/john-with-todpod-pants.jpg" alt="Dr. Shepherd holding the small green compression shorts of the Tod Pod Pediatric Option, next to the Bod Pod chamber" style="width: 100%; height: auto; border-radius: var(--radius);">
</div>
<figcaption style="font-size: 0.85rem; color: var(--gray-700); margin-top: 0.75rem; font-style: italic;">Pediatric Option to assess children as small as 12 kg and between the ages of 2 and 6 years. The option is essentially a high-chair insert, a little head cap, and little shorts. Also known as the "Tod Pod" for <em>Toddler</em>.</figcaption>
</figure>
